...
namespace Illuminate\Routing {
    ...
    class Router implements RegistrarContract
    {
        ...
        protected function runRouteWithinStack(Route $route, Request $request)
        {
            ...
            return (new Pipeline($this->container))->send($request)->through($middleware)->then(
...
namespace Illuminate\Routing {
    ...
    class RouteCollection implements Countable, IteratorAggregate
    {
        ...
        {
            return Arr::first(
                $routes, function ($value) use ($request, $includingMethod) {
...
namespace Illuminate\Database\Eloquent {
    ...
    abstract class Model implements ArrayAccess, Arrayable, Jsonable, JsonSerializable, QueueableEntity, UrlRoutable
    {
        ...
        protected function getBelongsToManyCaller()
        {
            $self = __FUNCTION__;
            $caller = Arr::first(
                debug_backtrace(DEBUG_BACKTRACE_IGNORE_ARGS), function ($trace) use ($self) {
...
namespace Illuminate\Support {
    ...
    class Collection implements ArrayAccess, Arrayable, Countable, IteratorAggregate, Jsonable, JsonSerializable
    {
        ...
        public function unique($key = null, $strict = false)
        {
            ...
            $exists = [];
            return $this->reject(
                function ($item) use ($key, $strict, &$exists) {
...
namespace Illuminate\Support {
    ...
    class MessageBag implements Arrayable, Countable, Jsonable, JsonSerializable, MessageBagContract, MessageProvider
    {
        ...
        {
            return collect($this->messages)->filter(
